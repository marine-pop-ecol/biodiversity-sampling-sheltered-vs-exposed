...
Our analysis found that there was no significant difference between the Shannon-Wiener indexes of the exposed and sheltered sites. The p-value for this Anova test was 0.218. Similarly, the p value of the richness and evenness Anova analysis were 0.43 and 0.78 respectively. In all cases, we cannot reject the null hypothesis that there is no relationship between site location and diversity, richness and evenness (Table 1). 
...
knitr::kable(summary.data, table.attr = "style='width:70%", caption = "Species richness evenness and Shannon-Wiener Diversity Index values of the exposed and sheltered sites at Scott's Bay, Bamfield, Canada. Determined using 10 quadrats haphazardly sampled along two parallel transect lines per site.")
```
